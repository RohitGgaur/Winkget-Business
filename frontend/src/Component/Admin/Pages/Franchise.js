                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    {step === 2 && (
                      <>
                        ...
                        <div className="form-group">
                         ...
                         <div className="form-group">
                        <select className="form-control" value={city} onChange={handleCityChange} required>
                    ...
                    {step === 3 && (
                      <>
                        ...
                        <select className="form-control" style={{height:"50px"}}value={category} onChange={handleCategoryChange} required>

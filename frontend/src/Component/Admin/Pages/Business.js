...
const Business = ({ closeModal, categoryId, subId }) => {
          ...
          {isModalOpen && (
            <div className="modal-overlay1">
              <div className="modal-content0">
                ...
                <h5 className='text-center'>Register Vendor (Step {step} of 3)</h5>

                <form onSubmit={handleSubmit}>
                  {/* Step 1 */}
                  {step === 1 && (
                    <>
                      <h7 style={{ marginTop: "9px" }}>Personal Information</h7>
                     ...
                     <div className="form-grp">
                      ...
                      <div className="row mt-3">
                        <input
                          ...
                          accept="image/*"
                          style={{ height: "50px",border:"0.01px solid black",width:"572px"}}
                        />
                  ...
                  {step === 5 && (
                    <>
                      <h4 style={{ marginTop: "30px" }}>About Business</h4>
                      <div className="form-grp">
                        <input
                          type="text"
                          id="about"
                  ...
                  <div className="button-group">
                    {step > 1 && <button type="button" onClick={() => setStep(step - 1)} style={{ width: "90px", height: "40px", background: "green", color: "white", border: "1px solid black", borderRadius: "5px", marginRight: "360px" }}>Back</button>}
                    {step < 5 && <button type="button" onClick={() => setStep(step + 1)} style={{ width: "90px", height: "40px", background: "green", color: "white", border: "1px solid black", borderRadius: "5px" }}>Next</button>}
                    {step === 5 && <button type="submit" className="btn btn-primary1" style={{ width: "90px", height: "40px", background: "blue", color: "white", border: "1px solid black", borderRadius: "5px" }}>Submit</button>}
                  </div>
                </form>
              </div>
            </div>
